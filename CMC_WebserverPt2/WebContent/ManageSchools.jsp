<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="java.util.*, CMC_Classes.School, CMC_Classes.*"%>
<%
				...
				<tbody>
					...
					<tr>
						<th colspan="17"><center>
								<h1>Schools Currently in the CMC System</h1>
							</center></th>
					</tr>
					<tr>
						<th colspan="17"><a href="AddNewSchool.jsp">Add New
								School</a></th>
					</tr>
					...
					<tr>
						...
						<th>SAT Math</th>
						<th>Expenses</th>
						<th>% with<br>Financial<br>Aid
						</th>
						<th># of<br>Applicants
						</th>
						<th>% Admitted</th>
						<th>% Enrolled</th>
						<th>Academics<br>Scale (1-5)
						</th>
						<th>Social<br>Scale<br>(1-5)
						</th>
						<th>Quality<br>of Life<br>Scale<br>(1-5)
						</th>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
							<form action="ViewSchool.jsp" method="post">
								<input type="hidden" name="schoolID" value=<%=i%>> <input

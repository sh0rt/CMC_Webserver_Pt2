...
<body>
	<div id="SeaSchMenuItems">
		...
		<table style="text-align: left; height: 500px; width: 974px;"
			...
			<tbody>
				<tr>
					<td style="vertical-align: top; width: 276px;">by SCHOOL NAME<br>
					</td>
					<td style="vertical-align: top; width: 680px;">contains <input
						name="schoolName"><br>
					</td>
				</tr>
				<tr>
					<td style="vertical-align: top; width: 276px;">by STATE<br>
					</td>
					<td style="vertical-align: top; width: 680px;">contains <input
						name="state"><br>
					</td>
				...
				<tr>
					<td style="vertical-align: top; width: 276px;">by LOCATION<br>
					</td>
					<td style="vertical-align: top; width: 680px;"><input
						name="location"> (SUBURBAN, URBAN, SMALL-CITY OR -1 FOR
						UNKNOWN)<br></td>
				</tr>
				<tr>
					<td style="vertical-align: top; width: 276px;">by CONTROL<br>
					</td>
					<td style="vertical-align: top; width: 680px;"><input
				...
				<tr>
					<td style="vertical-align: top; width: 276px;">by NUMBER OF
						STUDENTS<br>
					</td>
					<td style="vertical-align: top; width: 680px;">between&nbsp;<input
						name="numberOfStudents"> and <input
						name="numberOfStudents1"><br>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="vertical-align: top; width: 276px;">by % FINANCIAL
						AID<br>
					</td>
					<td style="vertical-align: top; width: 680px;">between&nbsp;<input
				...
				<tr>
					...
					<td style="vertical-align: top; width: 680px;">between&nbsp;<input
						name="numOfApplicants"> and&nbsp;<input
						name="numOfApplicants1"><br>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="vertical-align: top; width: 276px;">by ACADEMICS
						SCALE (1-5)<br>
					</td>
					<td style="vertical-align: top; width: 680px;">between&nbsp;<input
						name="academicScale"> and&nbsp;<input
						name="academicScale1"><br>
					</td>
				</tr>
				<tr>
					<td style="vertical-align: top; width: 276px;">by SOCIAL SCALE
						(1-5)<br>
					</td>
					<td style="vertical-align: top; width: 680px;">between&nbsp;<input
				...
				<tr>
					<td style="vertical-align: top; width: 276px;">by QUALITY OF
						LIFE SCALE (1-5)<br>
					</td>
					<td style="vertical-align: top; width: 680px;">between&nbsp;<input
				...
				<tr>
					<td style="vertical-align: top; width: 276px;">by EMPHASES<br>
					</td>
					<td style="vertical-align: top; width: 680px;">contains either<br>
						<input name="emphases1"><br> <input name="emphases2"><br>
						<input name="emphases3"><br> <input name="emphases4"><br>
